...
$filename = "html_templates/terms_conditions_$language.html";
if(file_exists($filename)) {
    $fileContents = file_get_contents($filename);
} else {
    $fileContents = file_get_contents("html_templates/terms_conditions_en.html");
}
    ...
    <div class="profile_container_all">
        <div class="profile_container_left">
            ...
            <div class="panel_logo_text">
                <?= localize('bo_sidebar_term_condition', $language) ?>
            </div>
