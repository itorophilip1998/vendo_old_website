...
define('DB_DSN','mysql:dbname=vendo;host=localhost;charset=utf8mb4');
define('DB_USER','vendo');
define('DB_PASS','97EG!p*ojZyx');

define('ROOT_URL','https://vendo.club/');
...
define('DURATION_TEMPORARY_CODE_VALID_SECONDS', 6*60*60);
...
define('COMMISSION_DELAY', 15); //commissions are calculated 15 days after payment has been started
