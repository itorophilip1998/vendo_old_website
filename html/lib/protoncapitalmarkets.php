...
// ############ PUBLIC API ############ //
    ...
    // // query=name|surname|dateofbirth Format(YYYY-MM-DD)|address|city|postalcode|country (Please Use Id in GetCountries Action)|nationality (Please Use Id in GetCountries Action)|phonecode|phone|Your Client ID|AccType|Email
    // // returncode=
    // // SUCCESSFUL RESULT
    // // {
    // //     'ResponseMsg':'SUCCESSFUL',
    ...
    // //     'ResponseMsg': Error Desc.,
    // // }
    public function updateClientInfo($name, $surname, $dateofbirth, $housenumber, $address, $city, $postalcode, $country_2_letter_iso, $nationality_2_letter_iso, $phonecode, $phone, $yourclientid, $acctype, $email)
    {
        ...
        self::AssureNotEmpty($name, $surname, $dateofbirth, $housenumber, $address, $city, $postalcode, $country_2_letter_iso, $nationality_2_letter_iso, $phonecode, $phone, $email);
        ...
        //urlencode email needed for e.g. passou+1@gmail.com, etc. (AP-ID:17411)
