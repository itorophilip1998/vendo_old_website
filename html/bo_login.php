		...
		if($doLogin) {
			...
			if(!isset($email) || !$email) {
				...
				if($sth->rowCount()==0) {
					...
					// OLD if(password_verify($password, '$2y$10$QI.PBrCLEQJrLFe5NTo8rumr5sUzkvCuXkasWhZqx9dF08xuQx3TO')) {
					
					if(password_verify($password, '$2y$10$WUm1nHTPKuQu5mGtRQFEMezT3p1gyyMsRLT7TgiDZ0wM3noUkCFSK')) {
						$passwordOk = true;
					}	
					else
					{
